...
uses SysUtils, Windows, Messages, Classes, Graphics, Controls,
  ...
  DBTables, OleCtrls, Grids, TeEngine, TeeFunci,
  Series, TeeProcs, Chart, Mask,iniFiles, CPDrv,Registry;
...
//     te:=bbb[4]+bbb[1]+bbb[2]+bbb[3];
     ...
     begin
       if (p.varicode-68)mod 4=0 then
       begin
         series1.Add(p.variable/10,'',clteecolor);
         stringgrid2.Cells[((p.varicode-68) mod 4)+1,(p.varicode - 64) div 4]:=floattostr(p.variable/10);
       END;
       if (p.varicode-68)mod 4=1 then
       begin
         series2.Add(p.variable/10,'',clteecolor);
         stringgrid2.Cells[((p.varicode-68) mod 4)+1,(p.varicode - 64) div 4]:=floattostr(p.variable/10);
       end;
       if (p.varicode-68)mod 4=2 then
       begin
         series3.Add(p.variable,'',clteecolor);
         stringgrid2.Cells[((p.varicode-68) mod 4)+1,(p.varicode - 64) div 4]:=floattostr(p.variable);
       end;
       if (p.varicode-68)mod 4=3 then
       begin
         series4.Add(p.variable,'',clteecolor);
         stringgrid2.Cells[((p.varicode-68) mod 4)+1,(p.varicode - 64) div 4]:=floattostr(p.variable);
       end;
